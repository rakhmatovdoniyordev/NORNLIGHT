...
const Header = () => {
  ...
  return (
    <header className='bg-white max-[990px]:mb-[190px] sticky top-0 left-0 z-[80] pb-3'>
        <div className="container__person">
            ...
            <nav className='h-[60px] flex items-center gap-7 max-[990px]:my-4 max-[990px]:mb-28  max-[550px]:gap-4 max-[990px]:fixed max-[990px]:top-[-3%] max-[990px]:left-0 w-full max-[990px]:h-[125px] max-[990px]:bg-white max-[990px]:items-start max-[990px]:pt-5 z-40 max-[990px]:shadow-sm'>
                ...
                <form action="" className='flex p-4 items-center border-[1px] border-[#454545] rounded-[100px] flex-1 max-[990px]:absolute max-[990px]:top-[80px] max-[990px]:w-full max-[990px]:z-10 max-[600px]:top-[70px] max-[990px]:p-[10px]'>
                ...
                <div className='flex gap-[31px] items-center max-[600px]:gap-3 max-[600px]:items-center max-[600px]:mt-1 mr-4'>
                    ...
                    <NavLink to={"/basket"} href="#" className='flex flex-col items-center gap-2 text-[14px] font-semibold max-[600px]:text-[0px] relative'>
        ...
        <div
            ...
            className={`w-screen h-screen fixed text-center z-50 bg-[#45454549] duration-700 top-[70px] max-[600px]:top-[60px]
        ...
        <div className='bg-white pt-5'>
            ...
            <a href="#" className='flex items-center justify-center gap-3 py-[14px] px-[27px] rounded-[100px] bg-[#454545] border-[1px] border-[#454545] text-white duration-500 hover:bg-white hover:text-[#454545]'>
                <HiOutlineBars3CenterLeft className='text-[24px]' /> Каталог
            </a>
            </div>

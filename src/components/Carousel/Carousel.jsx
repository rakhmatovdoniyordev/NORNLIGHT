          ...
          <div className="container__two">
            ...
            >
              ...
              <SwiperSlide>
                <div className='w-full bg-[#F2F2F2] flex gap-[200px] items-center justify-center rounded-[50px] pb-10 max-[1040px]:flex-wrap-reverse max-[1040px]:gap-[50px] max-[600px]:gap-7'>
                  <div>
                    <h2 className='text-[64px] max-w-[588px] font-bold max-[800px]:text-[46px] max-[660px]:text-[32px] max-[450px]:text-[28px]'>Скидка 50% <br />на все подвесные светильники <br /><span className='py-3 px-6 rounded-[50px] bg-[#454545] text-white max-[660px]:py-[6px]'>до 23 февраля</span></h2>
                  </div>
                  <div>
                    <img src={img2} alt="" />
                  </div>
